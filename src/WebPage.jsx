...
const WebPage = () => {
  return (
    <div>
      <nav className="flex items-center bg-red-700 justify-around p-3">
        <div className="flex items-center mr-5 text-white">
          <h1 className="font-bold text-xxl">Kalvium</h1>
        </div>
        ...
        <div className=" block flex-grow sm:flex sm:items-center ">
          <div className="sm:flex-grow">
            <a
              href="#"
              className=" mt-4 mb-3 text-white mr-4"
            >
              About us
            </a>
            <a href="#" className=" mt-4 text-white mr-4">
              Courses
            </a>
          ...
          <div>
            <a
              href="#"
              className="px-4 py-2 border rounded text-white border-grey mr-4"
            >
              Login
            </a>
          </div>
